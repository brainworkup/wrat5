...
plucked_tables_wais4 <- neuro2::gpluck_extract_table(
  file = file,
  pages = pages,
  area = area,
  guess = "FALSE",
...
# Handles non-numeric and missing values gracefully by converting them to NA
convert_columns <- function(df, to_integer, to_double, to_factor) {
  df <- df |>
    mutate(across(all_of(to_integer), ~ as.numeric(as.character(.x)), .names = "{.col}")) |>
    mutate(across(all_of(to_integer), as.integer, .names = "{.col}")) |>
    mutate(across(all_of(to_double), ~ as.numeric(as.character(.x)), .names = "{.col}")) |>
...
test <- params$test
test_name <- params$test_name
table1 <- neuro2::gpluck_make_columns(
  table1,
  range = "",
  test = test,
  test_name = test_name,
...
table1 <- neuro2::gpluck_make_score_ranges(table = table1, test_type = "npsych_test")
```
...
table2 <- neuro2::gpluck_make_columns(
  table2,
  range = "",
  ci_95 = "",
  test = params$test,
...
table2 <- neuro2::gpluck_make_score_ranges(
  table = table2,
  test_type = "npsych_test"
)
```
...
to_double <- c("raw_score", "score", "percentile")
table3 <- convert_columns(table3, c(), to_double, c())
...
table3 <- neuro2::gpluck_make_columns(
  table3,
  range = "",
  ci_95 = "",
  test = params$test,
...
table3 <- neuro2::gpluck_make_score_ranges(table = table3, test_type = "npsych_test")
```
...
to_double <- c("raw_score", "score", "percentile")
table4 <- convert_columns(table4, c(), to_double, c())
...
table4 <- neuro2::gpluck_make_columns(
  table4,
  range = "",
  ci_95 = "",
  test = params$test,
...
table4 <- neuro2::gpluck_make_score_ranges(table = table4, test_type = "npsych_test")
```
...
to_double <- c("raw_score", "score", "percentile")
table5 <- convert_columns(table5, c(), to_double, c())
...
table5 <- neuro2::gpluck_make_columns(
  table5,
  range = "",
  ci_95 = "",
  test = params$test,
...
table5 <- neuro2::gpluck_make_score_ranges(table = table5, test_type = "npsych_test")
```
...
to_double <- c("raw_score", "score", "percentile")
table6 <- convert_columns(table6, c(), to_double, c())
...
table6 <- neuro2::gpluck_make_columns(
  table6,
  range = "",
  ci_95 = "",
  test = params$test,
...
table6 <- neuro2::gpluck_make_score_ranges(table = table6, test_type = "npsych_test")
```
...
to_double <- c("raw_score", "score", "percentile")
table7 <- convert_columns(table7, c(), to_double, c())
...
table7 <- neuro2::gpluck_make_columns(
  table7,
  range = "",
  ci_95 = "",
  test = params$test,
...
table7 <- neuro2::gpluck_make_score_ranges(table = table7, test_type = "npsych_test")
```
