...
```{r}
# file_path <- here::here("data-raw", "pdf", "pai.pdf")
# read_content <- readr::read_lines(file_path)
```
...
plucked_tables <-
  readr::read_csv(
    here::here("data-raw", "pariconnectexportPAI.csv")
  )
```
...
df_adhd <- plucked_tables |>
  dplyr::select(all_of(adhd_items)) |>
  tidyr::gather() |>
  dplyr::rename(scale = key, score = value)
```
...
```{r ranges}
df_clinical <- neuro2::gpluck_make_score_ranges(
  table = df_clinical,
  test_type = "rating_scale"
)
df_validity <- neuro2::gpluck_make_score_ranges(
  table = df_validity,
  test_type = "validity_indicator"
)
df_inatt <- neuro2::gpluck_make_score_ranges(
  table = df_inatt,
  test_type = "rating_scale"
)
```
...
df_clinical <-
  ...
  dplyr::mutate(
    domain = dplyr::case_when(
      ...
      scale == "Psychotic Experiences" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Social Detachment" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Thought Disorder" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Aggression" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Aggressive Attitude" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Verbal Aggression" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Physical Aggression" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Suicidal Ideation" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Stress" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Nonsupport" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Treatment Rejection" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Dominance" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Warmth" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Borderline Features" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Affective Instability" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Identity Problems" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Negative Relationships" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Self-Harm" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Antisocial Features" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Antisocial Behaviors" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Egocentricity" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Stimulus-Seeking" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Alcohol Problems" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Drug Problems" ~ "Emotional/Behavioral/Social/Personality",
      scale == "ALC Estimated Score" ~ "Emotional/Behavioral/Social/Personality",
      scale == "DRG Estimated Score" ~ "Emotional/Behavioral/Social/Personality",
...
readr::write_csv(
  df_clinical,
  here::here("data-raw", "csv", "pai_clinical.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_csv(
  df_validity,
  here::here("data-raw", "csv", "pai_validity.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_csv(
  df_inatt,
  here::here("data-raw", "csv", "pai_inatt.csv"),
  col_names = TRUE,
  na = ""
)
```
