...
# patient <- "Biggie"
# file <- file.choose()
# area <- neuro2::gpluck_locate_areas(
#   file = file,
...
```{r ranges}
table1 <- neuro2::gpluck_make_score_ranges(
  table = table1,
  test_type = "npsych_test"
)
...
table3 <- neuro2::gpluck_make_score_ranges(
  table = table3,
  test_type = "npsych_test"
)
table4 <- neuro2::gpluck_make_score_ranges(
  table = table4,
  test_type = "npsych_test"
)
table5 <- neuro2::gpluck_make_score_ranges(
  table = table5,
  test_type = "npsych_test"
)
table6 <- neuro2::gpluck_make_score_ranges(
  table = table6,
  test_type = "npsych_test"
)
table7 <- neuro2::gpluck_make_score_ranges(
  table = table7,
  test_type = "npsych_test"
)
```
...
table2 <-
  ...
  dplyr::mutate(
    description = dplyr::case_when(
      ...
      scale == "Trials 1-5 Correct" ~
        "Learning and recall of rote verbal information (word list)",
      scale == "Delayed Recall Correct" ~
        "Delayed recall total correct",
      scale == "Total Recall Correct" ~
...
if (params$test == "cvlt3") {
  readr::write_csv(
    cvlt3,
    here::here("data-raw", "csv", "cvlt3.csv")
  )
} else if (params$test == "cvlt3_brief") {
  readr::write_csv(
    cvlt3_brief,
    here::here("data-raw", "csv", "cvlt3_brief.csv")
  )
}
```
